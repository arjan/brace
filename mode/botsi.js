    ...
    var BotsiHighlightRules = function() {
      ...
      var buildinConstants = (
        ...
        var builtinFunctions = (
          "accumulate|if|else|after|once|when|branch|do|end|import|repeat|in|accumulate|dialog|task|test|elixir|def|defp|say|ask|prompt|continue|await|emit|expect|assert|log|invoke|perform|stop|reset|show|http_post|http_get|http_put|http_patch|http_delete|pause|type|remember|forget|tag|untag|gallery_template|list_template|buttons"
          + "|mail|cancel_emit"
        );
