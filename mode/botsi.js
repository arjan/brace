    ...
    var BotsiHighlightRules = function() {
      ...
      var buildinConstants = (
        ...
        var builtinFunctions = (
          "if|else|once|when|branch|do|end|import|repeat|in|dialog|task|elixir|def|defp|say|ask|await|emit|log|invoke|perform|stop|show|http_post|http_get|http_put|http_patch|http_delete|pause|type|remember|forget|tag|untag|template|buttons"
          + "|mail|cancel_emit"
        );
