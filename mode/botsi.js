ace.define("ace/mode/botsi_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(acequire, exports, module) {
    ...
    var BotsiHighlightRules = function() {
        ...
        var builtinFunctions = (
            "dialog|elixir|def|defp|say|ask|emit|reply|log|buttons|event|postback|invoke|image|audio|video|expecting|trigger|http_post|http_get|sleep|think|random|remember|forget|tag|untag|template|subtitle|image_url|default_action|webview_height_ratio|messenger_extensions|fallback_url|webview_share_button|url"
        );
